...
byline: Force pushing has been getting a bad wrap ever since it was invented, but it's actually the best way to push!
date: 2019-05-27
tags: [git,beginner]
comments: true
---
...
When they go through with a [`git bisect`](https://git-scm.com/docs/git-bisect) to find out what commit has an error, they'll be greated with the amazing message *"Nah actually this time"*!
